...
-- CreateTable
CREATE TABLE "AssistantRep" (
    "id" SERIAL NOT NULL,
    "createdAt" TIMESTAMP(3) NOT NULL DEFAULT CURRENT_TIMESTAMP,
    "studentId" INTEGER NOT NULL,
    "classSpaceId" INTEGER NOT NULL,

    CONSTRAINT "AssistantRep_pkey" PRIMARY KEY ("id")
);
...
-- CreateIndex
CREATE UNIQUE INDEX "AssistantRep_studentId_key" ON "AssistantRep"("studentId");

-- CreateIndex
CREATE UNIQUE INDEX "AssistantRep_studentId_classSpaceId_key" ON "AssistantRep"("studentId", "classSpaceId");
...
-- AddForeignKey
ALTER TABLE "AssistantRep" ADD CONSTRAINT "AssistantRep_studentId_fkey" FOREIGN KEY ("studentId") REFERENCES "Student"("id") ON DELETE CASCADE ON UPDATE CASCADE;

-- AddForeignKey
ALTER TABLE "AssistantRep" ADD CONSTRAINT "AssistantRep_classSpaceId_fkey" FOREIGN KEY ("classSpaceId") REFERENCES "ClassSpace"("id") ON DELETE CASCADE ON UPDATE CASCADE;
